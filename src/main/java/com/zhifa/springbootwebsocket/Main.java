package com.zhifa.springbootwebsocket;

import com.zhifa.springbootwebsocket.webSocket.WebSocket;
...
public class Main {
    public static void main(String[] args) {
        ...
        webSocket.setSession(session01);
        webSocket.setSession(session02);
